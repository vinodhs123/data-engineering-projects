...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/IBP_CEU/AZR_CEULTSTRELMTH",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ZLATESTRELM2',
	all_columns = [
		...
		"CAST(ZLATESTRELM2 AS STRING) AS ZLATESTRELM2",
		"CAST(LAG AS INT) AS LAG"
	],
	tar_cols = [

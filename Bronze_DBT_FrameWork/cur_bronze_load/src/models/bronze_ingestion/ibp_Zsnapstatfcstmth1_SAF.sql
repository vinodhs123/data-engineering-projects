...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/IBP_SAF/AZR_DEMAND_PRDLOCCUSTSORGSOFF_APACSA_ZA",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ZSNAPSTATFCSTMTH1',
	all_columns = [
		...
		"CAST(ZSNAPSTATFCSTMTH1 AS STRING) AS ZSNAPSTATFCSTMTH1",

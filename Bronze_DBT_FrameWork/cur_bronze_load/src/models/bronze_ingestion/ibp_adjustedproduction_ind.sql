...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/IBP_IND/AZR_SUPPLY_PRODLOCSRC_APACSA_IN",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ADJUSTEDPRODUCTION',
	all_columns = [
		...
		"CAST(ADJUSTEDPRODUCTION AS STRING) AS ADJUSTEDPRODUCTION",

...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/ibp/AZR_CONSDMDQTY",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'CONSDMDQTY',
	all_columns = [
		...
		"CAST(CONSDMDQTY AS STRING) AS CONSDMDQTY",

...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/ibp/AZR_6WSRCDFC",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ZSNAPINTCOFCSTWK3',
	all_columns = [
		...
		"CAST(ZSNAPINTCOFCSTWK3 AS STRING) AS ZSNAPINTCOFCSTWK3",

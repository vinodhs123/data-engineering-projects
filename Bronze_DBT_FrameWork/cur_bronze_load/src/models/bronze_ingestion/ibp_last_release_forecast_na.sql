...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/ibp/AZR_LSTREL",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ZLASTRELEASE',
	all_columns = [
		...
		"CAST(ZLASTRELEASE AS STRING) AS ZLASTRELEASE",

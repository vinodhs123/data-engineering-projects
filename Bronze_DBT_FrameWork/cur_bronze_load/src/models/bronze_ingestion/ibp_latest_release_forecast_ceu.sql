...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/IBP_CEU/AZR_CEULTSTREL",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'ZLATESTREL',
	all_columns = [
		...
		"CAST(ZLATESTREL AS STRING) AS ZLATESTREL",

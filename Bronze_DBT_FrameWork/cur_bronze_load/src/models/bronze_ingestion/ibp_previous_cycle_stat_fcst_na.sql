...
{{ latest_folder_csvs(
    source_path="abfss://" ~ container_value2 ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/ibp/AZR_LSTCYCST",
    files_format = "csv",
    delimiter = ',',
	forecast_col = 'LSTCYCFCST',
	all_columns = [
		...
		"CAST(LSTCYCFCST AS STRING) AS LSTCYCFCST",

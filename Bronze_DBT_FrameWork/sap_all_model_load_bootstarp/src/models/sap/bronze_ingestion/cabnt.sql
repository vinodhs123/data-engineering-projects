...
{{ load_data_with_metadata(
    historical_source="abfss://" ~ container_value ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/" ~ bootstrap_storage_location ~"/cabnt.parquet",
    incremental_source="abfss://" ~ container_value ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/" ~ incremental_storage_location ~"/cabnt/",
    all_columns=[
		{"name": "mandt", "data_type": "STRING"},
		{"name": "atinn", "data_type": "STRING"},
		{"name": "spras", "data_type": "STRING"},
		{"name": "adzhl", "data_type": "STRING"},
		{"name": "atbez", "data_type": "STRING"},
		{"name": "atue1", "data_type": "STRING"},
		{"name": "atue2", "data_type": "STRING"},
    ...
    composite_keys=["mandt","atinn","spras","adzhl"],

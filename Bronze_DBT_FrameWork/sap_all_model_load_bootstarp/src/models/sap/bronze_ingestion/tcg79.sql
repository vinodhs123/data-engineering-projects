...
{{ load_data_with_metadata(
    historical_source="abfss://" ~ container_value ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/" ~ bootstrap_storage_location ~"/tcg79.parquet",
    incremental_source="abfss://" ~ container_value ~ "@" ~ storage_account_value ~ ".dfs.core.windows.net/" ~ incremental_storage_location ~"/tcg79/",
    all_columns=[
		{"name": "mandt", "data_type": "STRING"},
		{"name": "langu", "data_type": "STRING"},
		{"name": "compexcval", "data_type": "STRING"},
		{"name": "compexcvalnam", "data_type": "STRING"},
		{"name": "tas_rp_change_date", "data_type": "TIMESTAMP"},
		{"name": "tas_rp_opcode", "data_type": "INT"}
	],
    composite_keys=["mandt","langu","compexcval"],

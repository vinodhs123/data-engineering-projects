...
The 'bronze_dbt_load' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `bronze_dbt_load` directory. We recommend making
...
`[dev yourname] bronze_dbt_load_job` to your workspace.
...
When deploying to this target, note that the default job at resources/bronze_dbt_load.job.yml
